        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              'flex h-10 w-full rounded-lg border border-gray-6 bg-gray-1 py-2 text-sm ring-offset-gray-1 transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-10 hover:border-gray-7 focus-visible:border-primary-9 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-4 disabled:cursor-not-allowed disabled:opacity-50',
            )}
            ref={ref}
            {...props}
          />
